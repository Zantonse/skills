...
**Source:** [aplaceforallmystuff/claude-art-skill](https://github.com/aplaceforallmystuff/claude-art-skill)
...
Some content types intentionally use different aesthetics than their host site.
...
|-------|---------------|-------|
| **Default** | `~/.claude/skills/nano-banana-art/aesthetic.md` | Hand-drawn sketch, cream backgrounds, teal/orange accents |

**To add a new aesthetic:** Create a new file at `~/.claude/skills/nano-banana-art/aesthetics/[name].md` using the default aesthetic as a template. See `aesthetics/README.md` for the required format.
...
| Model | When to Use |
|-------|-------------|
| **nano-banana-2** | Faster iteration, cheaper (~50% cost), web search grounding, extended thinking |
...
**For detailed prompting techniques:** `~/.claude/skills/nano-banana-art/references/prompt-guide.md`
...
**For complete visual styling rules, ALWAYS read:** `~/.claude/skills/nano-banana-art/aesthetic.md`
